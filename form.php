...
<link rel="stylesheet" href="./css/style.css">
 ...
 <form class="form-group" method="post" action="app/connection.php">
  ...
  <br>
  <input type="text" class="form-control" name="h1" placeholder="Heading 1" required>
  <br>
  ...
  <br>
  <input type="text" class="form-control" name="img1" placeholer="Image one">
  ...
  <br>
  <input type="text" class="form-control" name="img2" placeholer="Image two">
  ...
  <br>
  <input type="text" class="form-control" name="img3" placeholer="Image three">
